                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <input
                                    class="form-control @error('name')
                                            is-invalid
                                        @enderror"
                                    type="text" placeholder="Enter name" name="name" value="{{ old('name',$volunteer->name) }}">
                                @error('name')
                            ...
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <input
                                    class="form-control @error('title')
                                            is-invalid
                                        @enderror"
                                    type="text" placeholder="Enter title" name="title" value="{{ old('title',$volunteer->title) }}">
                                @error('title')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-3 mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('twitter',$volunteer->twitter) }}">
                                @error('twitter')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input
                                    ...
                                    is-invalid
                                @enderror"
                                    type="file" name="photo" data-default-file='{{ asset('uploads/volunteer') }}/{{ $volunteer->photo }}'>
                                @error('photo')
