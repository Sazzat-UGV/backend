                        ...
                        <div class="row">
                            <div class="col-12 {{ Auth::user()->role->id == 1 ? 'col-md-5':'col-md-6' }} mb-4">
                                ...
                                <input class="form-control @error('role_name') is-invalid @enderror" type="text"
                                    placeholder="Enter name" name="role_name" value="{{ old('role_name', $role->name ?? '') }}">
                                @error('role_name')
                            ...
                            <div class="col-12 {{ Auth::user()->role->id == 1 ? 'col-md-5':'col-md-6' }} mb-4">
                                ...
                                <input class="form-control @error('role_note') is-invalid @enderror" type="text"
                                    placeholder="Enter note" name="role_note" value="{{ old('role_note', $role->note ?? '') }}">
                                @error('role_note')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                                ...
                                <div class="mt-5">
                                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                                        @foreach ($modules as $module)
                                            <div class="col mb-4">
                                                <h5 class="text-warning" style="font-weight: 600">Module: {{ $module->name }}</h5>
