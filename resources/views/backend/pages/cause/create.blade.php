        ...
        <div class="col-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endcan
                    <form action="{{ route('admin.cause.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-md-2 mb-4">
                                ...
                                <input
                                    class="form-control @error('goal')
                                            is-invalid
                                        @enderror"
                                    type="text" name="goal" value="{{ old('goal') }}" placeholder="Enter goal">
                                @error('goal')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
